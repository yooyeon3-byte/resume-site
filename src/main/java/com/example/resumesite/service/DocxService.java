...
public class DocxService {
     ...
     * @param htmlContent 렌더링된 HTML 내용
     * @param imageBaseUri 이미지 상대 경로를 해석할 Base URI (주로 파일 시스템 URI)
     */
    public byte[] convertHtmlToDocx(String htmlContent, String imageBaseUri) throws Exception {
        // 1. DOCX 패키지 생성
